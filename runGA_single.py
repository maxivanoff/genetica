...
num_cycles=5 # number of GA cycles
cross_rate = 1.0
mutation_rate = 0.0
...
if rank==0:
    ...
    env = Environment.SingleEnvironment(objectives, var_ranges, size, max_gen, cross_rate, mutation_rate, num_cycles,function, output)
    env.run()
else:
